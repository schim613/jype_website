...
<div class="main-banner">
  <!-- <iframe width="1920" height="800" src="https://www.youtube.com/embed/EaswWiwMVs8?autoplay=1&mute=1?" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
  <!-- <ul class="video">
    <li><a href="#"><video src="resource/img/StrayKids_소리꾼_MV.mp4" autoplay loop muted></video></a></li>
    <li><a href="#"><video src="resource/img/" autoplay loop muted></video></a></li>
    <li><a href="#"></a></li>
    <li><a href="#"></a></li>
  </ul> -->
...
<div class="slider-box-2 play-list">
  ...
  <!-- If we need navigation buttons -->
  <div class="play-list__nav">
    <div class="play-list__btn-prev"></div>
    <div class="play-list__btn-next"></div>
  </div>
</div>
